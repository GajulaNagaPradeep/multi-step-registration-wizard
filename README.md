...
To run the project first start the MongoDB server as explained above and then execute the following commands in sequence from the `multi-step-registration-wizard` folder.
